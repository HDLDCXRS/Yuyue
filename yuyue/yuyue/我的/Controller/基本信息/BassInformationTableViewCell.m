//
//  BassInformationTableViewCell.m
//  yuYue
//
...
@implementation BassInformationTableViewCell
...
//        int width = [self getStrWidth:_titlleLabel.text withFont:14.0];
        ...
        _inputTextField = [UITextField textFieldWithFrame:CGRectZero backgroundColor:[UIColor whiteColor] placeholder:nil clearsOnBeginEditing:YES andDelegate:self];
